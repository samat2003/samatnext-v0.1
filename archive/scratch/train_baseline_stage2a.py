...
Data: data/stage2a_code_pretrain.jsonl
Teacher: N/A
Hyperparams: lr=5e-5, warmup=100, grad_clip=0.5, 2000 optimizer updates, fp32
"""
...
TRAIN_FILE = os.path.join(ROOT, "data", "stage2a_code_pretrain.jsonl")
CKPT_DIR   = os.path.join(ROOT, "checkpoints")
RESULTS    = os.path.join(ROOT, "results", "baseline_stage2a_log.json")
os.makedirs(os.path.join(ROOT, "results"), exist_ok=True)

BEST_CKPT  = os.path.join(CKPT_DIR, "transformer_350m_baseline_stage2a_best.pt")
STEP_CKPT  = os.path.join(CKPT_DIR, "transformer_350m_baseline_stage2a_step_{step}.pt")
...
def main():
    ...
    dataset = Stage2ADataset(TRAIN_FILE, tok, MAX_SEQ)
