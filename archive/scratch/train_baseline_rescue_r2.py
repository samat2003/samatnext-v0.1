...
RESULTS    = os.path.join(ROOT, "results", "baseline_rescue_r2_log.json")
os.makedirs(os.path.join(ROOT, "results"), exist_ok=True)

BEST_CKPT  = os.path.join(CKPT_DIR, "transformer_350m_baseline_rescue_r2_best.pt")
STEP_CKPT  = os.path.join(CKPT_DIR, "transformer_350m_baseline_rescue_r2_step_{step}.pt")
