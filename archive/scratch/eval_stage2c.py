...
def main():
    ...
    ckpt_path = args.ckpt or os.path.join(ROOT, "checkpoints", "samat_next_350m_stage2c_best.pt")
    ...
    eval_file = os.path.join(ROOT, "data", "stage2c_synthetic_eval.jsonl")
    prompts = []
    ...
    print(f"Exact Task Match    : {test_pass_count}/{n}  ({test_pass_count/n*100:.1f}%)")
