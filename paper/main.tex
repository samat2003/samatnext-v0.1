...
\begin{itemize}
    ...
    \item \textbf{Current Source Commit:} \texttt{bc833343b4195667fbfa9d0dc5d8b60a8ab1b243}
...
Table~\ref{tab:vram_spec_app} details the peak VRAM consumption for forward passes at various context lengths, benchmarked on an NVIDIA GeForce RTX 5070 Ti Laptop GPU. The VRAM measurements are reported on a consumer NVIDIA GeForce RTX 5070 Ti Laptop GPU to document low-resource reproducibility rather than server-scale throughput.
