...
RESULTS    = os.path.join(ROOT, "results", "baseline_curriculum_stage5_log.json")
os.makedirs(os.path.join(ROOT, "results"), exist_ok=True)

BEST_CKPT  = os.path.join(CKPT_DIR, "transformer_350m_baseline_curriculum_stage5_best.pt")
STEP_CKPT  = os.path.join(CKPT_DIR, "transformer_350m_baseline_curriculum_stage5_step_{step}.pt")
